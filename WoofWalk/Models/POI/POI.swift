...
enum PoiType: String, CaseIterable, Codable {
    ...
    var displayName: String {
        switch self {
        case .bin: return "Poo Bin"
        case .hazard: return "Watch Out!"
        case .water: return "Water Stop"
        case .dogPark: return "Dog Park"
        case .park: return "Green Space"
        case .church: return "Landmark"
        case .landscape: return "Scenic Spot"
        case .accessNote: return "Good to Know"
        case .livestock: return "Livestock Nearby"
        case .wildlife: return "Wildlife Area"
        case .amenity: return "Handy Spot"
        case .bench: return "Rest Spot"
        case .picnicSite: return "Picnic Spot"
        case .picnicTable: return "Picnic Table"
        case .attraction: return "Must See"
        case .viewpoint: return "Great View"
        ...
        case .vet: return "Emergency Vet"
        case .toilet: return "Loo"
        case .fountain: return "Drinking Fountain"
