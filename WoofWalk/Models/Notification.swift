...
struct NotificationRecord: Identifiable, Codable {
    ...
    init(id: String = UUID().uuidString, type: String = "", title: String = "", body: String = "", imageUrl: String? = nil, data: [String: String] = [:], read: Bool = false, delivered: Bool = false, deliveredAt: Int64? = nil, clicked: Bool = false, clickedAt: Int64? = nil, dismissed: Bool = false, createdAt: Int64 = Int64(Date().timeIntervalSince1970 * 1000)) {
        self.id = id; self.type = type; self.title = title; self.body = body; self.imageUrl = imageUrl; self.data = data; self.read = read; self.delivered = delivered; self.deliveredAt = deliveredAt; self.clicked = clicked; self.clickedAt = clickedAt; self.dismissed = dismissed; self.createdAt = createdAt
    }
