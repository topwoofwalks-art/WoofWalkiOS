...
struct BadgeDetailSheet: View {
    ...
    private func criteriaIcon(_ type: CriteriaType) -> String {
        ...
        case .photosUploaded: return "camera"
        case .hazardsReported: return "exclamationmark.triangle"
        case .earlyBirdWalks: return "sunrise"
        case .nightOwlWalks: return "moon.stars"
        case .uniqueParksVisited: return "leaf"
    ...
    private func criteriaText(_ criteria: BadgeCriteria) -> String {
        ...
        case .photosUploaded: return "Upload \(criteria.targetValue) photos"
        case .hazardsReported: return "Report \(criteria.targetValue) hazards"
        case .earlyBirdWalks: return "Complete \(criteria.targetValue) walks before 7 am"
        case .nightOwlWalks: return "Complete \(criteria.targetValue) walks after 9 pm"
        case .uniqueParksVisited: return "Visit \(criteria.targetValue) different parks"
    ...
    private func tipText(for badge: Badge) -> String {
        ...
        case .photosUploaded: return "Snap a photo on your walks — every upload counts."
        case .hazardsReported: return "Spot a broken stile, a missing bin, or aggressive livestock? Report it to help other walkers."
        case .earlyBirdWalks: return "Get out before 7 am — sunrise walks count toward this badge."
        case .nightOwlWalks: return "Late-evening walks (after 9 pm) all stack up here."
        case .uniqueParksVisited: return "Try a new park each week to grow your unique-parks count."
